...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/addressbook

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/addressbook
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/addressbook
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/addressbook
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/addressbook
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/addressbook
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/addressbook
%attr (-,root,root) /usr/share/gosa/locale/plugins/addressbook
%attr (-,root,root) /usr/share/gosa/html/plugins/addressbook
