...
# Distribution
#
Summary:                MIT kerberos management plugin
Name:                   gosa-plugin-mit-krb5
Version:                2.6.11
Release:                0
License:                GPL
...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/mit-krb5

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/mit-krb5
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/mit-krb5
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/mit-krb5
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/mit-krb5
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/mit-krb5
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/mit-krb5
%attr (-,root,root) /usr/share/gosa/locale/plugins/mit-krb5
%attr (-,root,root) /usr/share/gosa/html/plugins/mit-krb5
