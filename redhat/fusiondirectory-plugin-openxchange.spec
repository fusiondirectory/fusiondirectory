...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/openxchange

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/openxchange
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/openxchange
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/openxchange
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/openxchange
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/openxchange
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/openxchange
%attr (-,root,root) /usr/share/gosa/locale/plugins/openxchange
%attr (-,root,root) /usr/share/gosa/html/plugins/openxchange
