...
# Distribution
#
Summary:                Open-Xchange account plugin
Name:                   fusiondirectory-plugin-openxchange
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/openxchange

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/openxchange
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/openxchange
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/openxchange
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/openxchange
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/openxchange
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/openxchange
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/openxchange
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/openxchange
