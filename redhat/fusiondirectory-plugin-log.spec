...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/log

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/log
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/log
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/log
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/log
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/log
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/log
%attr (-,root,root) /usr/share/gosa/locale/plugins/log
%attr (-,root,root) /usr/share/gosa/html/plugins/log
