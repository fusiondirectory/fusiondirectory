...
Name:                   gosa-plugin-phpscheduleit
Version:                2.6.11
Release:                0
License:                GPL
...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/phpscheduleit

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/phpscheduleit
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/phpscheduleit
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/phpscheduleit
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/phpscheduleit
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/phpscheduleit
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/phpscheduleit
%attr (-,root,root) /usr/share/gosa/locale/plugins/phpscheduleit
%attr (-,root,root) /usr/share/gosa/html/plugins/phpscheduleit
