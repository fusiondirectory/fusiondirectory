...
# Distribution
#
Summary:                PHP scheduleit connectivity plugin
Name:                   fusiondirectory-plugin-phpscheduleit
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/phpscheduleit

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/phpscheduleit
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/phpscheduleit
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/phpscheduleit
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/phpscheduleit
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/phpscheduleit
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/phpscheduleit
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/phpscheduleit
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/phpscheduleit
