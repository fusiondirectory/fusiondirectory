...
# Distribution
#
Summary:                Syslog and GOsa logging plugin
Name:                   gosa-plugin-rsyslog
Version:                2.6.11
Release:                0
License:                GPL
...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/rsyslog

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/rsyslog
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/rsyslog
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/rsyslog
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/rsyslog
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/rsyslog
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/rsyslog
%attr (-,root,root) /usr/share/gosa/locale/plugins/rsyslog
%attr (-,root,root) /usr/share/gosa/html/plugins/rsyslog
