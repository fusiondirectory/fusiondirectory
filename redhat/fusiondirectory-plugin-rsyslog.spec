...
# Distribution
#
Summary:                Syslog and fusiondirectory logging plugin
Name:                   fusiondirectory-plugin-rsyslog
Version:                1.0
Release:                1
License:                GPL
...
%description
Syslog and fusiondirectory logging plugin
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/rsyslog

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/rsyslog
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/rsyslog
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/rsyslog
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/rsyslog
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/rsyslog
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/rsyslog
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/rsyslog
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/rsyslog
