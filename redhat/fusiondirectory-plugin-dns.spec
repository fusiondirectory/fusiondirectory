...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/dns

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/dns
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/dns
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/dns
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/dns
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/dns
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/dns
%attr (-,root,root) /usr/share/gosa/locale/plugins/dns
%attr (-,root,root) /usr/share/gosa/html/plugins/dns
