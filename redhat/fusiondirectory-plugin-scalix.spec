...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/scalix

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/scalix
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/scalix
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/scalix
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/scalix
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/scalix
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/scalix
%attr (-,root,root) /usr/share/gosa/locale/plugins/scalix
%attr (-,root,root) /usr/share/gosa/html/plugins/scalix
