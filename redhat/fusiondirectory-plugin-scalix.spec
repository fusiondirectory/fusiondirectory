...
# Distribution
#
Summary:                Scalix account plugin
Name:                   fusiondirectory-plugin-scalix
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/scalix

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/scalix
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/scalix
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/scalix
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/scalix
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/scalix
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/scalix
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/scalix
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/scalix
