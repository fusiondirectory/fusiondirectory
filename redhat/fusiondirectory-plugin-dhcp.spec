...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/dhcp

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/dhcp
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/dhcp
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/dhcp
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/dhcp
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/dhcp
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/dhcp
%attr (-,root,root) /usr/share/gosa/locale/plugins/dhcp
%attr (-,root,root) /usr/share/gosa/html/plugins/dhcp
