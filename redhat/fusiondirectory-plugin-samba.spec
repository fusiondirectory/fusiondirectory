...
# Distribution
#
Summary:                Plugin for Samba 2/3 integration
Name:                   fusiondirectory-plugin-samba
Version:                1.0
Release:                1
License:                GPL
...
%description
Plugin for Samba 2/3 integration
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/samba

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/samba
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/samba
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/samba
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/samba
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/samba
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/samba
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/samba
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/samba
