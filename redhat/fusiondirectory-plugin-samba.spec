...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/samba

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/samba
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/samba
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/samba
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/samba
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/samba
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/samba
%attr (-,root,root) /usr/share/gosa/locale/plugins/samba
%attr (-,root,root) /usr/share/gosa/html/plugins/samba
