...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/mail

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/mail
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/mail
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/mail
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/mail
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/mail
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/mail
%attr (-,root,root) /usr/share/gosa/locale/plugins/mail
%attr (-,root,root) /usr/share/gosa/html/plugins/mail
