...
# Distribution
#
Summary:                Mail management base plugin
Name:                   fusiondirectory-plugin-mail
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/mail

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/mail
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/mail
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/mail
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/mail
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/mail
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/mail
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/mail
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/mail
