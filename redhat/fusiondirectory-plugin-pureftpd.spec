...
Name:                   fusiondirectory-plugin-pureftpd
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/pureftpd

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/pureftpd
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/pureftpd
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/pureftpd
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/pureftpd
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/pureftpd
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/pureftpd
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/pureftpd
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/pureftpd
