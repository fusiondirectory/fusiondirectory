...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/squid

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/squid
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/squid
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/squid
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/squid
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/squid
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/squid
%attr (-,root,root) /usr/share/gosa/locale/plugins/squid
%attr (-,root,root) /usr/share/gosa/html/plugins/squid
