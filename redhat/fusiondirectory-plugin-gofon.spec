...
# Distribution
#
Summary:                GOfon backend management with report functionality
Name:                   fusiondirectory-plugin-gofon
Version:                1.0
Release:                1
License:                GPL
...
%description
GOfon backend management with report functionality
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/gofon

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/gofon
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/gofon
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/gofon
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/gofon
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/gofon
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/gofon
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/gofon
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/gofon
