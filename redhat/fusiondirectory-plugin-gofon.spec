...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/gofon

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/gofon
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/gofon
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/gofon
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/gofon
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/gofon
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/gofon
%attr (-,root,root) /usr/share/gosa/locale/plugins/gofon
%attr (-,root,root) /usr/share/gosa/html/plugins/gofon
