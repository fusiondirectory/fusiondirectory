...
Name:                   gosa-plugin-rolemanagement
Version:                2.6.11
Release:                0
License:                GPL
...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/rolemanagement

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/rolemanagement
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/rolemanagement
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/rolemanagement
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/rolemanagement
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/rolemanagement
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/rolemanagement
%attr (-,root,root) /usr/share/gosa/locale/plugins/rolemanagement
%attr (-,root,root) /usr/share/gosa/html/plugins/rolemanagement
