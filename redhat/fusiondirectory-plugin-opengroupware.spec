...
Name:                   gosa-plugin-opengroupware
Version:                2.6.11
Release:                0
License:                GPL
...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/opengroupware

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/opengroupware
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/opengroupware
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/opengroupware
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/opengroupware
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/opengroupware
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/opengroupware
%attr (-,root,root) /usr/share/gosa/locale/plugins/opengroupware
%attr (-,root,root) /usr/share/gosa/html/plugins/opengroupware
