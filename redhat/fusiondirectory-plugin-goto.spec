...
# Distribution
#
Summary:                GOto desktop management plugin
Name:                   fusiondirectory-plugin-goto
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/goto

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/goto
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/goto
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/goto
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/goto
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/goto
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/goto
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/goto
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/goto
