...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/goto

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/goto
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/goto
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/goto
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/goto
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/goto
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/goto
%attr (-,root,root) /usr/share/gosa/locale/plugins/goto
%attr (-,root,root) /usr/share/gosa/html/plugins/goto
