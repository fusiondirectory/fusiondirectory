...
mkdir -p %{buildroot}/usr/share/gosa/html/plugins/webdav

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/gosa/html/plugins/webdav
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/gosa/doc/plugins/webdav
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/gosa/doc/plugins/webdav
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/gosa/locale/plugins/webdav
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/gosa/locale/plugins/webdav
fi
...
%attr (-,root,root) /usr/share/gosa/doc/plugins/webdav
%attr (-,root,root) /usr/share/gosa/locale/plugins/webdav
%attr (-,root,root) /usr/share/gosa/html/plugins/webdav
