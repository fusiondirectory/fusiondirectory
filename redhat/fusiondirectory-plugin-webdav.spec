...
# Distribution
#
Summary:                WebDAV connectivity plugin
Name:                   fusiondirectory-plugin-webdav
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/webdav

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/webdav
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/webdav
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/webdav
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/webdav
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/webdav
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/webdav
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/webdav
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/webdav
