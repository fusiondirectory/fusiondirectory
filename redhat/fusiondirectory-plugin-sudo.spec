...
Name:                   fusiondirectory-plugin-sudo
Version:                1.0
Release:                1
License:                GPL
...
mkdir -p %{buildroot}/usr/share/fusiondirectory/html/plugins/sudo

echo "%{buildroot} <<---------" 

if ls ./html/* &> /dev/null ;then
	mv ./html/* %{buildroot}/usr/share/fusiondirectory/html/plugins/sudo
fi
...
# Move help
mkdir -p %{buildroot}/usr/share/fusiondirectory/doc/plugins/sudo
if ls ./help/* &> /dev/null ;then
	mv ./help/* %{buildroot}/usr/share/fusiondirectory/doc/plugins/sudo
fi
...
# Move localization
mkdir -p %{buildroot}/usr/share/fusiondirectory/locale/plugins/sudo
if ls ./locale/* &> /dev/null ;then
	mv ./locale/* %{buildroot}/usr/share/fusiondirectory/locale/plugins/sudo
fi
...
%attr (-,root,root) /usr/share/fusiondirectory/doc/plugins/sudo
%attr (-,root,root) /usr/share/fusiondirectory/locale/plugins/sudo
%attr (-,root,root) /usr/share/fusiondirectory/html/plugins/sudo
